...
//        [properties setValue:[NSString stringWithFormat:@"%@",_fsnSession] forKey:NSHTTPCookieValue];
//        [properties setValue:@"PHPSESSID" forKey:NSHTTPCookieName];
//        [properties setValue:@"192.168.10.6:9091" forKey:NSHTTPCookieDomain];
                      ...
                      delegate:(id<FMNetworkProtocol>)networkDelegate
{
    ...
    NSString *md5 = [NSString md5Str:[NSString stringWithFormat:@"%@!asf@house#365$normaltrx",deviceid]];
