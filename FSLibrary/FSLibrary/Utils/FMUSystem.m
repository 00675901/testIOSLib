...
//#endif
    ...
    if (!udid) udid = @"00000000";
    return udid;
    /*
    UIDevice *device = [UIDevice currentDevice];
    NSString *udid = @"00000000";
    
    if (device.systemVersion.floatValue >= 6) {
        udid = [[device identifierForVendor] UUIDString];
    }
    else
    {
        udid = [FMUSystem macAddress];
    }
#define kFMUSystemDeviceId  @"kFMUSystemDeviceId"
//    NSString *udid = [[NSUserDefaults standardUserDefaults] objectForKey:kFMUSystemDeviceId];
//    if (!udid)
//    {
//        udid = [NSString md5Str:[[NSProcessInfo processInfo] globallyUniqueString]];
//        if (udid) {
//            [[NSUserDefaults standardUserDefaults] setObject:udid forKey:kFMUSystemDeviceId];
//        }
//        else
//        {
//            udid = @"00000000";
